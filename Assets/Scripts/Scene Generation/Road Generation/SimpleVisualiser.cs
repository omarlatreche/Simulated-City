...
{
    public LSystemStringBuilder lSystem;
    ...
    private void VisualiseSequence(string sequence)
    {
        ...
        {
            GameObject node = Instantiate(prefab, position, Quaternion.identity);
            node.transform.SetParent(gameObject.transform); // Make child of City
        }
    }
    ...
    private void DrawLine(Vector3 start, Vector3 end, Color color)
    {
        ...
        line.transform.SetParent(gameObject.transform); // Make child of City
